        ...
        if($lang == 'en'){
            return [
                'authentication' => [
                    ...
                    'reset_password_sent'=>'A link has been sent to your email to reset your password. If you do not find the message in your inbox, please check your spam folder.',
                    
                    'reset_password_expired_link'=>'The password reset link you used has expired.',
                    'reset_password_wrong_link'=>'Invalid password reset link.',
