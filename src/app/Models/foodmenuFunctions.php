        ...
        if($lang == 'en'){
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Credit card to delivery man',
                    'cashOnPickup' => 'Cash at the restaurant',
                    'cardOnPickup' => 'Credit card at the restaurant',
                ...
                'receipt' => [
                    'tel' => 'tel',
                    'cashOnDelivery' => 'Cash on delivery',
                    'cardOnDelivery' => 'Payment card to the delivery man',
                    'cashOnPickup' => 'Cash at the restaurant',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'بطاقة ائتمان لرجل التوصيل',
                    'cashOnPickup' => 'نقدا في المطعم',
                    'cardOnPickup' => 'بطاقة ائتمان في المطعم',
                ...
                'receipt' => [
                    'tel' => 'هاتف',
                    'cashOnDelivery' => 'الدفع عند الاستلام',
                    'cardOnDelivery' => 'بطاقة الدفع لموظف التوصيل',
                    'cashOnPickup' => 'نقدا في المطعم',
                    'cardOnPickup' => 'بطاقة الدفع في المطعم',
                    'tax' => 'ضريبة',
                    'service' => 'خدمة',
            ...
            return  [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Carte de crédit au livreur',
                    'cashOnPickup' => 'Espèces au restaurant',
                    'cardOnPickup' => 'Carte de crédit au restaurant',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Kreditkarte an Zusteller',
                    'cashOnPickup' => 'Bargeld im Restaurant',
                    'cardOnPickup' => 'Kreditkarte im Restaurant',
            ...
            return  [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Tarjeta de crédito al repartidor',
                    'cashOnPickup' => 'efectivo en el restaurante',
                    'cardOnPickup' => 'Tarjeta de crédito en el restaurante',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Carta di credito al fattorino',
                    'cashOnPickup' => 'Contanti al ristorante',
                    'cardOnPickup' => 'Carta di credito al ristorante',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Кредитная карта курьеру',
                    'cashOnPickup' => 'Наличные в ресторане',
                    'cardOnPickup' => 'Кредитная карта в ресторане',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'cardOnDelivery' => 'Кредитна картка кур\'єру',
                    'cashOnPickup' => 'Готівка в ресторані',
                    'cardOnPickup' => 'Кредитна картка в ресторані',
    ...
    public static function archiveStatistice($orders,$reviews,$website_id,$day,$month,$year,$timeZone){
        ...
        foreach($orders as $order){
            ...
            if($order->delivered_by == 1){
                ...
                $time = date_diff(new DateTime($order->withDelivery_at),new DateTime($order->delivered_at));
