...
class foodmenuFunctions
{
        ...
        if($lang == 'en'){
            return [
                'authentication' => [
                    ...
                    'nameMax' => "The name must be maximum 20 characters.",
                    'nameMin' => "The name must be at least 5 characters.",
                    'passwordRequired' => 'Please enter a valid password.',
                    'passwordMin' => "The password must be at least 8 characters.",
                    'passwordMax' => "The password must be maximum 20 characters.",
                    'phoneNumberRequired' => 'Please enter your valid phone number.',
                    'phoneNumberRegex' => 'The phone number you entered is incorrect.',
                    'phoneNumberUnique' => 'The phone number you entered is already used by another user.',
                    'addressRequired' => 'Please enter your address.',
                    'accountCreated'=>'You have successfully registered. You can now log in.',
                    'wait10mins'=> 'We already sent a password reset message to your email less than 10 minutes ago. You can send a password reset message once every ten minutes.',
                    'wrongEmail'=>'The email address you entered is incorrect.',
                    'resetPasswordemailSent'=>'A link has been sent to your email to reset your password. If you do not find the message in your inbox, please check your spam folder.',
                    'expiredRecoverPasswordToken'=>'The password reset link you used has expired.',
                    'wrongRecoverPasswordToken'=>'Invalid password reset link.',
                    'passwordChanged' => 'The password has been changed successfully. You can now log in to your account with your new password.',
                    ...
                    'changePasswordSaved'=>'Your password has been changed successfully.',
            ...
            return [
                'authentication' => [
                    ...
                    'rememberMe' => 'تذكرنى',
                    'forgetPasswordQ' => 'هل نسيت كلمة المرور',
                    'dontHaveAccountQ' => "ليس لديك حساب؟ سجل حساب جديد",
                    'haveAccountLogin' => 'هل لديك حساب؟ تسجيل الدخول',
                    'signup' => 'سجل حساب جديد',
                    'name' => 'الاسم',
                    'phoneNumber' => 'رقم الهاتف',
                    'address' => 'العنوان',
                    'mylocation' => 'موقعي علي الخريطة',
                    'currentLocation' => 'تعيين موقعي الحالي',
                    'unsetLocation' => 'موقع غير محدد',
                    'savedLocation' => 'اضبط موقعي المحفوظ',
                    'resetPassword'=>'إعادة ضبط كلمة المرور',
                    'emailForResetPassword'=>'أدخل بريدك الإلكتروني المسجل',
                    'createNewPassword' => 'أنشئ كلمة مرور جديدة',
                    'newPassword' => 'أدخل كلمة مرور جديدة',
                    'profile' => 'ملفي الشخصي',
                    'save' => 'حفظ',
                    'changeEmail'=> 'تغيير البريد الإلكتروني الخاص بي',
                    'newEmail' => 'أدخل بريدك الإلكتروني الجديد',
                    'changePassword'=>'تغيير كلمة المرور الخاصة بي',
                    'userBanned' => 'هذا الحساب تم حظره',
                    'loginFail' => 'البريد الإلكتروني أو كلمة المرور غير صحيحة',
                    'emailUnique' => 'البريد الإلكتروني الذي أدخلته له حساب بالفعل!',
                    'emailRequired' => 'الرجاء إدخال بريد إلكتروني صالح.',
                    'emailEmail' => 'عنوان البريد الإلكتروني الذي أدخلته غير صحيح',
                    'nameRequired' => 'من فضلك ادخل اسمك.',
                    'nameMax' => "لا يمكن أن يكون الاسم أكثر من:max أحرف",
                    'nameMin' => "لا يمكن أن يكون الاسم أقل من:min أحرف",
                    'passwordRequired' => 'الرجاء إدخال كلمة مرور صالحة.',
                    'passwordMin' => "لا يمكن أن تكون كلمة المرور أقل من :min أحرف.",
                    'passwordMax' => "لا يمكن أن تكون كلمة المرور أكثر من :max أحرف.",
                    'phoneNumberRequired' => 'الرجاء إدخال رقم هاتفك الصحيح.',
                    'phoneNumberRegex' => 'رقم الهاتف الذي أدخلته غير صحيح.',
                    'phoneNumberUnique' => 'رقم الهاتف الذي أدخلته مستخدم بالفعل من قبل مستخدم آخر',
                    'addressRequired' => 'الرجاء إدخال عنوانك',
                    'accountCreated'=>'لقد قمت بالتسجيل بنجاح. يمكنك الآن تسجيل الدخول',
                    'wait10mins'=> 'لقد أرسلنا بالفعل رسالة إعادة تعيين كلمة المرور إلى بريدك الإلكتروني قبل أقل من 10 دقائق. يمكنك إرسال رسالة إعادة تعيين كلمة المرور مرة كل عشر دقائق.',
                    'wrongEmail'=>'عنوان البريد الإلكتروني الذي أدخلته غير صحيح',
                    'resetPasswordemailSent'=>'تم إرسال رساله إلى  بريدك الإلكتروني تحتوي على رابط لإعادة تعيين كلمة المرور الخاصة بك. إذا لم تجد الرسالة في صندوق الوارد الخاص بك ، يرجى التحقق من مجلد البريد العشوائي.',
                    'expiredRecoverPasswordToken'=>'انتهت صلاحية رابط إعادة تعيين كلمة المرور الذي استخدمته',
                    'wrongRecoverPasswordToken'=>'رابط إعادة تعيين كلمة المرور غير صالح',
                    'passwordChanged' => 'تم تغيير كلمة المرور بنجاح. يمكنك الآن تسجيل الدخول إلى حسابك باستخدام كلمة المرور الجديدة',
                    'profileSaved'=>'تم حفظ البيانات بنجاح',
                    'profileSaveFail'=>'خطأ غير معروف ، لم يتم حفظ البيانات',
                    'changeEmailSaved'=>'تم تغيير عنوان بريدك الإلكتروني بنجاح',
                    'changeEmailSaveFail'=>'خطأ غير معروف ، لم يتم تغيير عنوان البريد الإلكتروني',
                    'changePasswordSaved'=>'تم تغيير كلمة المرور الخاصة بك بنجاح',
                    'changePasswordSaveFail'=>'خطأ غير معروف ، لم يتم تغيير كلمة المرور',
                    'privacypolicyError' => 'To signup, you must agree with our privacy policy.',
                ],
                'orders' => [
                    'noOnlineOrdering' => 'خدمة الطلب عبر الإنترنت غير متوفرة حاليًا.',
                    'trackMyOrder' => 'تتبع طلبي',
                    'trackOrder' => 'تتبع الطلب',
                    'orderNumber' => 'رقم الطلب',
                    'orderToChat' => '',
                    'findOrder' => 'البحث عن طلبي',
                    'wrongOrderNumber' => 'رقم طلب غير صحيح',
                    'orderCanceled' => 'تم إلغاء طلبك بنجاح.',
                    'orderCencelFail' => 'تعذر إلغاء طلبك. تم استلام طلبك بالفعل.',
                    'deliveryOrderPlaced'=>'تم تقديم طلبك بنجاح وسيتم تسليمه لك',
                    'pickupOrderPlaced' =>'تم إرسال طلبك بنجاح وسيكون جاهزًا للاستلام',
                    'orderPlacedSuccessfully' => 'تم ارسال طلبك بنجاح',
                    'orderPlaceFail' => '',
                    'ordersHistory' => 'سجل الطلبات',
                    'cart' => 'عربة التسوق',
                    'placeOrder' => 'قدم الطلب',
                    'addToCart'=>'أضف إلى عربة التسوق',
                    'itemNotice' => 'أخبرنا هنا بطلب خاص لهذا العنصر',
                    'specialRequest' => '',
                    'removeItem' => 'إزالة',
                    'howReceiveOrder'=>'كيف ترغب في استلام طلبك؟',
                    'homeDelivery'=>'توصيل منزلي',
                    'orderPickup' =>'استلام الطلب',
                    'deliverTo' => 'التوصيل إلى',
                    'yourAddress' => 'عنوانك',
                    'youPhoneNumber' => 'رقم تليفونك',
                    'orderLocation' => 'الموقع (اختياري)',
                    'orderNotice' => 'اترك لنا ملاحظة',
                    'orderNoticePlaceholder' => 'اكتب ملاحظتك هنا ...',
                    'phoneNumberValidation' => 'يرجى إدخال رقم الهاتف الخاص بك',
                    'addressValidation' => 'الرجاء إدخال عنوانك',
                    'orderReceipt' => 'إيصال الطلب',
                    'havePromocode' => 'هل لديك رمز ترويجي؟',
                    'cartTotal'=>'الإجمالي الفرعي',
                    'Tax'=> 'ضريبة',
                    'deliveryCost'=> 'خدمة التوصيل',
                    'service' => '',
                    'orderTotal' =>'المجموع',
                    'discount' => 'الخصم',
                    'orderMinimumCharge' =>'الحد الأدنى للرسوم هو',
                    'subtotalMinimumCharge' => '',
                    'totalMinimumCharge' => '',
                    'placeOrderFail' => 'خطأ غير معروف ، فشل في تقديم الطلب',
                    'quantity' => 'الكمية',
                    'total'=> 'الإجمالي',
                    ...
                    'pickupOutOfWorkingTimesCantOrder'=>'طلبات الاستلام خارج ساعات العمل في الوقت الحالي وستعود',
                    'deliveryOutOfWorkingTimesCantOrder'=>'خدمة التوصيل لدينا خارج ساعات العمل في الوقت الحالي وستعود',
                    'pickupOutOfWorkingTimesCanOrder'=>'طلبات الاستلام خارج ساعات العمل في الوقت الحالي ، ولكن لا يزال بإمكانك تقديم طلبك وسنقوم باستلامه',
                    'deliveryOutOfWorkingTimesCanOrder'=>'خدمة التوصيل لدينا خارج ساعات العمل في الوقت الحالي ، ولكن لا يزال بإمكانك تقديم طلبك وسنقوم باستلامه',
                    'nextsaturday'=>'السبت المقبل الساعة',
                    'nextsunday'=>'الأحد القادم الساعة',
                    'nextmonday'=>'الاثنين المقبل في',
                    'nexttuesday'=>'الثلاثاء القادم الساعة',
                    'nextwednesday'=>'الأربعاء القادم الساعة',
                    'nextthursday'=>'الخميس القادم الساعة',
                    'nextfriday'=>'الجمعة المقبل الساعة',
                    'todayAt' => 'اليوم الساعة',
                    'tomorrowAt' => 'غدا الساعة',
                    'am'=>'صباحا',
                    'pm'=>'مساء',
                    'orderItems' => 'المنتجات المطلوبة',
                    'copyItemsToCart' => 'نسخ إلى عربة التسوق',
                    'orderStatus' => 'الحالة',
                    'pending' => 'معلق',
                    'accepted' => 'مقبول',
                    'canceled' => 'تم الالغاء',
                    'withDelivery' => 'في الطريق اليك',
                    'readyToPickup' => 'جاهز للإستلام',
                    'delivered' => 'تم التوصيل',
                    'pickedUp' => 'تم الاستلام',
                    'dinein' => 'التناول فى المطعم',
                    ...
                    'in'=> 'في خلال',
                    'noOrdersInHistory' => "لم تقم بتقديم أي طلبات حتى الآن",
                    'deliveryCostCanBeChanged' =>"يرجى ملاحظة أنه يمكن تغيير تكلفة التوصيل بناءً على موقعك.",
                    'contactInfo' => 'معلومات التواصل',
                    'paymentMethod' => 'طريقة الدفع',
                    'cash_on_delivery' => 'الدفع عند الاستلام',
                    'card_on_delivery' => 'بطاقة ائتمان لرجل التوصيل',
                    'cash_at_restaurant' => 'نقدا في المطعم',
                    'card_at_restaurant' => 'بطاقة ائتمان في المطعم',
                    'paymentMethodValidation' => 'الرجاء اختيار طريقة الدفع',

                    'availableNow' => 'متاح الان',
                    'discountDeliveryUntil' => 'خصم لطلبات التوصيل للمنازل حتى',
                    'discountPickupUntil' => 'خصم على طلبات الاستلام من المطعم حتى',
                    'discountDineinUntil' => 'خصم على طلبات تناول الطعام في المطعم حتى',
                    'discountDeliverySoon' => 'خصم على طلبات التوصيل للمنازل قريبًا من',
                    'discountPickupSoon' => 'خصم على طلبات الاستلام من المطعم قريبًا من',
                    'discountDineinSoon' => 'خصم على طلبات تناول الطعام في المطعم قريبًا من',
                    'to' => 'حتي',
                    'loginToOrder' => 'لتتمكن من تقديم طلب ، يجب أن تقوم بتسجيل الدخول.',
                ],
                'reviews' => [
                    'collectReviewsTitle' => 'رأيك يهمنا',
                    'postReviewFails' => 'خطأ غير معروف ، فشل عملية نشر تقييمك!',
                    'postReviewPosted' => 'تم نشر التقييم بنجاح!',
                    'reviews' => 'آراء عملائنا',
                    'postedBy' => 'تم النشر بواسطة',
                    'aGuest' => 'زائر',
                    'guest' => 'زائر',
                    'loginRequiredToReview' => 'لتتمكن من تقييم هذا المنتج يجب عليك',
                    'loginRequiredToReview2' => 'تسجيل الدخول',
                    'reviewTitleRequired' => 'الرجاء إدخال عنوان التفييم',
                    'reviewRateRequired' => 'يرجى تقييم المنتج',
                    'reviewReviewRequired' => 'الرجاء كتابة رأيك',
                    'collectReviewRate' => 'تقييم',
                    'collectReviewReview' => 'أكتب رأيك',
                    'reviewTitle' => 'عنوان التقييم',
                    'enterYourReview' => 'أدخل رأيك هنا ...',
                    'postReview' => 'نشر',
                    'customersReviews'=> 'تقييمات عملائنا',
                    'seeMoreReviews' => 'المزيد من التقييمات',
                    'postNewReview' => 'انشر تقييم جديدة',
                    'reviewRating' => 'تقييم',
                    'noReviews' => 'هذا المنتج ليس لديه أي تقيمات حتى الآن',
                    'ourCustomersReviews' => 'Our Customers Reviews',
                ],
                'liveChat' =>[
                    'msgSent' => 'مرسل',
                    ...
                    'YourMessage' => 'الرسالة ...',
                    'send'=>'إرسال',
                    'msgInfo'=> 'معلومات الرسالة',
                    'deleteMsg' => 'حذف',
                    'cancelDeleteMsg' => 'إلغاء',
                    'deleteConfirmMsg' => 'هل أنت متأكد أنك تريد حذف هذه الرسالة؟',
                    'deletedmsg' => 'رسالة محذوفة!',
                    'msgSendFail' => 'فشل في إرسال الرسالة',
                    'resendMsg' => 'إعادة الإرسال',
                    'sendMessageCoolDown' => 'لقد قمت بإرسال رسائل كثيرة ، يرجى الانتظار!',
                    'loginToChat' => 'لتتمكن من الدردشة معنا ، يجب أن تقوم بتسجيل الدخول.',
                ],
                'other' => [
                    'new' => 'جديد',
                    'lastUpdate' => 'أخر تحديث',
                    'scrollToTop' => 'انتقل إلى أعلى',
                    ...
                    'contactUs' => 'اتصل بنا',
                    'deliveryWorkingHours' => 'ساعات عمل توصيل الطلبات للمنازل',
                    'pickupWorkingHours' => 'ساعات عمل استلام الطلب فى المطعم',
                    'dineinWorkingHours' => 'ساعات عمل تناول الاكل فى المطعم',
                    'aboutUs' => 'معلومات عنا',
                    'account' => 'الحساب',
                    ...
                    'mostPopularProducts' => 'المنتجات الأكثر شهرة',
                    'trendingProducts' => 'الأكثر رواجا',
                    ...
                    'friday' => 'الجمعة',
                    'saturday' => 'السبت',
                    'ourLocation' => 'موقعنا علي الخريطة',
                    'cookiesMsg' => 'من خلال الاستمرار في تصفح موقعنا ، فإنك توافق على تخزين ملفات تعريف الارتباط على جهازك لمساعدتنا على تذكر هويتك ولغتك المفضلة وعربة التسوق الخاصة بك.',
                    'agreeWith' => 'I agree with the',
                    'privacypolicy' => 'Privacy Policy',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'trackMyOrder' => 'Отслеживать свой заказ',
            ...
            return [
                ...
                'orders' => [
                    ...
                    'trackMyOrder' => 'Відстежуйте своє замовлення',
    ...
    public static function plans(){
        return [
            'small' => ['id' =>'prod_OIP4IZZBx8m5mK', 'monthlyId'=>'price_1NVoGgIYxD8tIsOHrDMmGqy4', 'yearlyId'=>'price_1NVoGhIYxD8tIsOHQ3RjuaaZ', 'monthlyCost'=>29, 'yearlyCost'=> 299, 'name'=>'small', 'subAccounts'=> 1, 'categories'=> 3, 'products'=> 15, 'productOptions'=>1, 'specialDomainName'=>false, 'storage'=>100, 'deliveryAccounts'=>2, 'websiteLangs' =>1, 'promocodes'=>1],
            'standard' => ['id' =>'prod_OIPX9hjzTOzh4D', 'monthlyId'=>'price_1NVoieIYxD8tIsOHVI61xEFV', 'yearlyId'=>'price_1NVoieIYxD8tIsOHpW6c29T9', 'monthlyCost'=>39, 'yearlyCost'=> 399, 'name'=>'standard', 'subAccounts'=> 4, 'categories'=> 6, 'products'=> 40, 'productOptions'=>4, 'specialDomainName'=>false, 'storage'=>300, 'deliveryAccounts'=>5, 'websiteLangs' =>3, 'promocodes'=>3],
            'large' => ['id' =>'prod_OIPZFTbddjU1Rh', 'monthlyId'=>'price_1NVokBIYxD8tIsOHrpHzox0p', 'yearlyId'=>'price_1NVokBIYxD8tIsOHBmkjlma0', 'monthlyCost'=>69, 'yearlyCost'=> 699, 'name'=>'large', 'subAccounts'=> 6, 'categories'=> 8, 'products'=> 100, 'productOptions'=>8, 'specialDomainName'=>false, 'storage'=>400, 'deliveryAccounts'=>10, 'websiteLangs' =>8, 'promocodes'=>5],
            'premium' => ['id' =>'prod_OIPa2clUfeg7KN', 'monthlyId'=>'price_1NVolUIYxD8tIsOHh0EA2OB4', 'yearlyId'=>'price_1NVolUIYxD8tIsOHDI6Hx2E8', 'monthlyCost'=>99, 'yearlyCost'=> 999, 'name'=>'premium', 'subAccounts'=> 10, 'categories'=> 15, 'products'=> 300, 'productOptions'=>10, 'specialDomainName'=>true, 'storage'=>500, 'deliveryAccounts'=>20, 'websiteLangs' =>8, 'promocodes'=>10],
