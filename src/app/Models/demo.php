...
class demo
{
    ...
    public static function category($demoWebsite,$category,$catSort){
        ...
        $createCat = categories::create([
            ...
            'description_en' => 'Here you can add a catchy description of your category. Tell your customers what they find therein!',
            'description_ar' => 'هنا يمكنك إضافة وصف جذاب لفئتك. أخبر عملائك بما وجدوه هناك!',
            'description_eg' => 'Here you can add a catchy description of your category. Tell your customers what they find therein!',
            'description_fr' => 'Ici, vous pouvez ajouter une description accrocheuse de votre catégorie. Dites à vos clients ce qu\'ils y trouvent !',
            'description_de' => 'Hier können Sie eine einprägsame Beschreibung Ihrer Kategorie hinzufügen. Sagen Sie Ihren Kunden, was sie darin finden!',
            'description_it' => 'Qui puoi aggiungere una descrizione accattivante della tua categoria. Dì ai tuoi clienti cosa trovano lì!',
            'description_es' => 'Aquí puede agregar una descripción pegadiza de su categoría. ¡Dile a tus clientes lo que encuentran allí!',
            'description_ru' => '',
            'description_ua' => 'Тут ви можете додати яскравий опис вашої категорії. Розкажіть своїм клієнтам, що вони там знаходять!',
        ]);
        $prodSort = 0;
