...
class your_product_reviews extends Seeder // please replace the article_id with the article title_id
{
    ...
    public function run()
    {
        ...
        $article = help_en_articles::create([
            ...
            'keyWords' => "product.reviews.rating",//the article keywords spreat them using . 
            'rating' => 0,
        ]);
        $sort = 0;
        ...
        array_push($sections,[
            ...
            'html' => <<<string
            <p>Including a rating and review system on your website engages your customers with your business, making them feel valued. This fosters trust and demonstrates that their opinions are important to your business.</p>
            string,
        ]);
