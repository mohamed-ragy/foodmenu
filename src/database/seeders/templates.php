    ...
    public function run()
    {
        ...
        $template = template::create([
            ...
            'website_header' => json_encode([
                ...
                'background_hover_mobile' => $background,
                "children" => [
                    'header_wrapper' => [
                        "tag" => "div",
                        "type" => "header_wrapper",
                    ...
                    'header_drop_down_list' => [
                        ...
                        'css' => [
                            ...
                            'overflow' => 'hidden',
                            //
                            "background-color" => "rgba(var(--color_4_7),1)",
                            'padding' => '1px 1px 1px 1px',
            ...
            'login_popup' => json_encode([
                ...
                'accessibility' => [
                    ...
                    'spacing','padding','margin',
                    'sizing','width','height',
                    'styling','box_shadow','border','border-radius',
                    'block_elems',
                ],
                'class' => '',
                'background' => $background,
                ...
                'children' => [
                    [
                        ...
                        'tag' => 'h1',
                        'accessibility' => [
                            'text','text_color','select_font',
                            'display',
                            'sizing','width','height',
                            'spacing','margin','padding',
                            'styling','border','border_radius','box_shadow',
                        ],
                        'class_selector' => 'login_popup_title',
                        'font_style' => ['en' => ''],
                        'class' => '',
                    ...
                    [
                        ...
                        'class_selector' => 'login_popup_description',
                        'font_style' => ['en' => ''],
                        'class' => '',
                    ...
                    [
                        ...
                        'accessibility' => [
                            'input',
                            'interactions','can_focus',
                            'text','text_color','select_font',
                            'sizing','width','height',
                            'spacing','margin','padding',
                            'styling','border','border_radius','box_shadow',
                        ],
                        'class_selector' => 'login_popup_email',
                        'font_style' => ['en' => ''],
                        'class' => 'input',
