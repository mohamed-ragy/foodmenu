...
$('body').on('input change','.receiptMsgInputText',function(e){
...
$('body').on('click','#settings-receiptMsgCancelBtn',function(e){
...
$('body').on('click','#settings-receiptMsgSaveBtn',function(){
