...
$('body').on('input change','.restaurantNameInputText',function(e){
...
$('body').on('click','#setting-restaurantName-CancelBtn',function(e){
...
$('body').on('click','#setting-restaurantName-SaveBtn',function(e){
