...
require('./editors/padding_selector.js')//
require('./editors/border_radius_selector.js')//
require('./editors/margin_selector.js')//
require('./editors/transform_selector.js')//
require('./editors/iamge_position_selector.js')//
require('./editors/border_style_selector.js')//
require('./editors/drop_shadow_selector.js')//
...
get_editor_val = function(editor){
    ...
    let is_hover = editors_container.attr('is_hover');
    ...
    }else if(is_responsive == '0' && is_hover == '1'){
        if(editors_container.find('.hover_selector_selected').attr('key') == 'regular'){
            return elem_data.val;
        }else if(editors_container.find('.hover_selector_selected').attr('key') == 'hover'){
            return elem_data.val_hover
        }
    }else if(is_responsive == '1' && is_hover == '1'){
        if(editors_container.find('.hover_selector_selected').attr('key') == 'regular'){
            if(editors_container.find('.responsive_selector_selected').attr('key') == 'general'){
                if(elem_data.val === elem_data.val_mobile || typeof(elem_data.val_mobile) === 'undefined'){
                    return elem_data.val;
            ...
            if(editors_container.find('.responsive_selector_selected').attr('key') == 'general'){
                if(elem_data.val_hover === elem_data.val_mobile_hover){
                    return elem_data.val_hover;
                }else{
                    return '--';
                }
                ...
                //     return elem_data.val_hover;
                // }else{
                    return elem_data.val_mobile_hover;
                // }
            }
        }
    }
...
set_val= function(editor,new_val){
    ...
    if(is_responsive == '0' && is_hover == '0'){
        ...
        if(editors_container.find('.hover_selector_selected').attr('key') == 'regular'){
            ...
            elem_data.data_hover[key] = new_val;
        }
    }else if(is_responsive == '1' && is_hover == '1'){
        if(editors_container.find('.hover_selector_selected').attr('key') == 'regular'){
            if(editors_container.find('.responsive_selector_selected').attr('key') == 'general'){
            ...
            if(editors_container.find('.responsive_selector_selected').attr('key') == 'general'){
                elem_data.data_hover[key] = new_val;
                elem_data.data_mobile_hover[key] = new_val;
                // delete elem_data.data_mobile_hover[key]
            }else if(editors_container.find('.responsive_selector_selected').attr('key') == 'desktop'){
                // if(typeof(elem_data.data_mobile_hover[key]) === 'undefined'){
                //     elem_data.data_mobile_hover[key] = elem_data.data_hover[key];
                // }
                elem_data.data_hover[key] = new_val;
            }else if(editors_container.find('.responsive_selector_selected').attr('key') == 'mobile'){
                elem_data.data_mobile_hover[key] = new_val;
