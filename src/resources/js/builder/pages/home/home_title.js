show_edit_home_title = function(key_tree){
    // deselect_all();
    // hidePopupSelectors();
    hide_editor_popup('editor');
    let title = get_key_tree(key_tree).elem;
    ...
    show_editor_popup('editor',function(){
        ...
        $('#editor').addClass('mnw400').find('.editor_popup_body').text('').append(
            $('<div/>',{class:'editor_popup_container',key:'home_elem_title'}).append(
                draw_editor_show_container({key:'title_text',name:texts.styling.text,row_class:true}),
                draw_editor_show_container({key:'title_positioning',name:texts.styling.positioning,row_class:true}),
                draw_editor_show_container({key:'title_backdrop_filter',name:texts.styling.backdrop_filter,row_class:true}),
                draw_editor_show_container({key:'title_border',name:texts.styling.border,row_class:true}),
                draw_editor_show_container({key:'title_shadow',name:texts.styling.drop_shadow,row_class:true}),
            ...
            $('<div/>',{class:'editor_popup_container none',key:'title_shadow',parent_key:'home_elem_title'}).append(
                draw_drop_shadow_select({
                    keys_arr:[`${key_tree}.css`],
                }),
            ),
            $('<div/>',{class:'editor_popup_container none',key:'title_animation',parent_key:'home_elem_title'}).append(
                draw_input_list({
                ...
                draw_editor_show_container({key:'title_animation_up_backdrop_filter',name:texts.styling.backdrop_filter,row_class:true}),
                ...
                draw_editor_show_container({key:'title_animation_down_backdrop_filter',name:texts.styling.backdrop_filter,row_class:true}),
            ...
            $('<div/>',{class:'editor_popup_container none',key:'title_animation_up_backdrop_filter',parent_key:'title_animation'}).append(
                draw_backdrop_filter({
                    keys_arr:[{key_tree:`${key_tree}.animation`,key:'animationUp_backdrop_filter'}],
                    container_class:'backdrop_filter_elem_animation',
                })
            ),
            $('<div/>',{class:'editor_popup_container none',key:'title_animation_down_backdrop_filter',parent_key:'title_animation'}).append(
                draw_backdrop_filter({
