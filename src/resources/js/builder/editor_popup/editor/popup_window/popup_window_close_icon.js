    ...
    show_editor_popup('editor',function(){
        $('#editor').find('.editor_popup_body').text('').append(
            draw_editors_container({
                is_responsive:true,
                editors:[
                    $('<div/>',{class:'w100p editor_popup_container',key:'popup_window_close_icon'}).append(
                            ...
                            draw_editors_container({
                                ...
                                editors:[
                                    draw_svg_icon_picker({
                                        ...
                                        render:`${window.selected}.children.popup_close`,
                                        variable_key:null,
                                        key:'popup_close',
                                        icon_type:'close',
                                    }),
                        ...
                        draw_editor_show_container({
                            key:'popup_window_close_icon_color',
                    ...
                    $('<div/>',{class:'w100p editor_popup_container none',key:'popup_window_close_icon_color',parent_key:'popup_window_close_icon'}).append(
                        draw_editors_container({
                            is_responsive:false,
