    ...
    show_editor_popup('editor',function(){
        $('#editor').find('.editor_popup_body').text('').append(
            $('<div/>',{class:'w100p-20 m10 row alnC jstfyC wrap'}).append(
                $('<div/>',{class:'editor_popup_header_components editor_header_settings select set_editor_popup_editor',key_tree:'website_header'}).append(
                    $('<div/>',{class:'ico-header '}),
                    $('<div/>',{text:texts.header_settings})
                ),
