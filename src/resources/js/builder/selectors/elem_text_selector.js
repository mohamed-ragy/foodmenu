            ...
            $('<div/>',{class:'elem_text_selector'}).append(
                ...
                $('<div/>',{class:'elem_text_selector_format_btns'}).append(
                    ...
                    $('<div/>',{tooltip:texts.styling.font_color,class:''}).append(
                        $('<input/>',{format_action:'color',class:`color_picker color_picker_hidden elem_text_selector_format_btn3_picker color_picker_no_action`,type:'text',style:`background-color:rgba(0,0,0,1)`,value:'rgba(0,0,0,1)',formate_action:'color'}),
                    ...
                    $('<div/>',{tooltip:texts.styling.bg_color,class:''}).append(
                        $('<input/>',{format_action:'background_color',class:`color_picker color_picker_hidden elem_text_selector_format_btn3_picker color_picker_no_action`,type:'text',style:`background-color:rgba(0,0,0,1)`,value:'rgba(0,0,0,1)',formate_action:'background_color'}),
                        $('<button/>',{class:'elem_text_selector_format_btn3 elem_text_selector_format_btn_style elem_text_selector_format_btn_style_2'}).append(
