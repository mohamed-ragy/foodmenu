...
$('body').on('keydown','.text_editor_editor',function(e){
    if(e.ctrlKey ){
        if(
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 65 ||
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 67 ||
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 86 ||
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 88 ||
            e.shiftKey && ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 90 ||
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 90 ||
            ((e.ctrlKey || e.metaKey) || e.metaKey) && e.which == 83
