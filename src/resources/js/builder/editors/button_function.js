...
draw_button_function_hyperlinks_contextMenu = function(){
    return $('<div/>',{class:'w100p'}).append(
        ...
        // window.template.settings.selected_page == 'home' ? draw_contextMenu_elem({icon:'',child1_text:texts.website_pages.scroll_to_section,child2_class:'ico-arrowRight',submenu:draw_button_function_hyperlinks_scroll_to_section_contextMenu()}) : '',
        draw_contextMenu_elem({icon:'',child1_text:texts.website_pages.scroll_to_section,child2_class:'ico-arrowRight',submenu:draw_button_function_hyperlinks_scroll_to_section_contextMenu()}),
    )
}
