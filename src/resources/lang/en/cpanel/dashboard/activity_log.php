...
return [
    ...
    "settings.restaurant_info.social_media_links" => "Your <a class='cpPage' cpPage='restaurant_information' openTab='social_media_links' >social media links</a> has been modified by :account:.",
    ...
    "settings.language.edit_options" => "The language :lang: settings have been changed by :account:.",
    ...
    "settings.service.workingDays" => "The :service_name_workingHours: working day settings have been modified by :account:.",
    //
