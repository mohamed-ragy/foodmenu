...
return [
    ...
    //
    "subaccount.unblocked" => ":subaccount:'s subaccount has been unblocked by :account:.",
    ...
    "subaccount.password_changed" => "The subaccount password for :subaccount: has been modified by :account:.",
    "subaccount.authorities_changed" => "The subaccount permissions for :subaccount: has been modified by :account:.",
    //
    ...
    "order.to_delivery_man" => "Order :order: has been marked as out for delivery and assigned to :delivery: by :account:.",
    ...
    "order.diningin" => "Order :order: has been marked as dineing in by :account:.",
    ...
    "order.update.phoneNumber" => "The phone number included in the order :order: has been changed by :account:.",
    "order.update.address" => "The delivery address for order :order: has been changed by :account:.",
    ...
    "order.update.itemNotice" => "A modification has been made in the special request for :product: in order :order: by :account:.",
    "order.update.qty" => "The item quantity for :product: has been modified from :old_qty: to :new_qty: for order :order: by :account:.",
    "order.update.selection" => "The selection for :product: variant :option: has been changed from :old_selection: to :new_selection: for order :order: by :account:.",
    //
    "product.created" => ":product: has been created by :account:.",
    "product.deleted" => ":product: has been deleted by :account:.",
    "product.availability" => ":product: has been set as :availability: by :account:.",
    "product.edited" => ":product: has been modified by :account:.",
    "product.option.created" => "A new variant called :option: has been created from the product :product: by :account:.",
    ...
    "product.selection.create" => "A new selection called :selection: has been added to the :option: variant in the product :product: by :account:.",
    "product.selection.deleted" => "The selection :selection: found in the variant :option: has been deleted from the product :product: by :account:.",
    "product.selection.edited" => "The selection :selection: found in the variant :option: has been modified from the product :product: by :account:.",
    //
    ...
    "security.phone.created" => "A security <a class='cpPage' cpPage='phone_number'>phone number</a> has been attached to the main account.",
    ...
    "settings.country" => "<a class='cpPage' cpPage='system' openTab='region'>The account country</a> has been changed from :old_country: to :new_country: by :account:.",
    ...
    "settings.restaurant_info.restaurant_phone_numbers" => "Your <a class='cpPage' cpPage='restaurant_information' openTab='restaurant_phone_numbers' >restaurant's contact numbers</a> has been changed by :account:.",
    ...
    "settings.restaurant_info.restaurant_location" => "Your <a class='cpPage' cpPage='restaurant_information' openTab='restaurant_location' >restaurant's location settings</a> has been modified by :account:.",
    ...
    "settings.restaurant_info.social_media_links" => "The <a class='cpPage' cpPage='restaurant_information' openTab='social_media_links' >social media links</a> has been modified by :account:.",
    ...
    "settings.promocode.edit" => "The promocode :promocode: settings has been changed by :account:",
    ...
    "settings.language.edit_options" => "The language :lang: options has been changed by :account:.",
    ...
    "settings.pickup.averagePickupTime" => "The <a class='cpPage' cpPage='order_pickup_settings' openTab='average_pickup_time'>avrage time to prepare a pickup order</a> has been changed by :account:.",
    "settings.pickup.paymentMethods" => "The order pickup service <a class='cpPage' cpPage='order_pickup_settings' openTab='pickup_payment_methods'>payment methods</a> has been changed by :account:.",
    ...
    "settings.delivery.paymentMethods" => "The delivery service service <a class='cpPage' cpPage='home_delivery_settings' openTab='delivery_payment_methods'>payment methods</a> has been changed by :account:.",
    "settings.delivery.averageDeliveryTime" => "The <a class='cpPage' cpPage='home_delivery_settings' openTab='average_delivery_time'>avrage delivery time</a> has been changed by :account:.",
    "settings.delivery.deliveryCost" => "The home <a class='cpPage' cpPage='home_delivery_settings' openTab='delivery_fees'>delivery service fees settings</a> has been changed by :account:.",
    ...
    "settings.service.workingDays" => "The :service_name_workingHours: working days settings has been modified by :account:.",
    //
    ...
    "user.banned" => ":user: has been banned by :account:.",
