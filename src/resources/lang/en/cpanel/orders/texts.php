...
return [
    ...
    'total' => 'Total',
    'happyHourNotice' => 'Available now happy hour for :service: with :discount:% discount.',
    ...
    ///activites
    'order.new_order_by_user' => "The order has been placed by :user:.",
    "order.canceled_by_user" => "The order has been canceled by :user:.",
    "order.new_order_by_account" => "The order has been placed by :account:.",
];
