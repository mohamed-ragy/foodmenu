...
<body>
    ...
    <div class="galleryFullScreen none">
        <div class="ic-close galleryFullScreenClose" showTooltip="other.close"></div>
        <div class="galleryFullScreenImgContainer">
            <div class="ic-left galleryFullScreenArrowLeft"></div>
            <div class="ic-right galleryFullScreenArrowRight"></div>
            <img src="" class="galleryFullScreenImg" alt="">
        </div>
    </div>
