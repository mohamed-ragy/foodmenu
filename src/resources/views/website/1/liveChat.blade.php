    ...
    <div class="liveChatContainer none">
        <div id="liveChatHead">
            <div class="row alnC jstfyC">
                ...
                <span class="mX-5 restaurantName"></span>
            </div>
            <div class="ic-close pointer" id="liveCloseChat"></div>
        </div>
        <div id="liveChatLoading" class="loadingChat none mX-a mT-20 zx-10 w-100p" style="top:60px;left:0;"></div>
...
{{-- <div class="navCart cart" showTooltip="orders.cart">
    <span class="ic-cart navCartIcon"></span>
    <span class="cartItemsNumber navCartItemsNumber"></span>
</div> --}}
