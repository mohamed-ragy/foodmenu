<div class="popupWindowCover none">
    <div class="popup">
        ...
        <div id="collectReviews-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        <div  id="collectReviews-popup" class="popupContent w-600">
            <div class="column alnC jstfyC m-a">
                ...
                <div class="cE collectReviewsError none fs-09"></div>
        ...
        <div  id="login-popup" class="popupContent">
            <div id="login-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
            <div class="column alnC jstfyC m-a">
        ...
        <div  id="signup-popup" class="popupContent">
            <div id="signup-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="forgetPassword-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="createNewPassword-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="cart-Loading" class="loading none  zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="addToCart-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="placeOrder-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        <div  id="placeOrder-popup" class="popupContent  w-600">
            ...
            <div class="placeOrder-orderDetails" id="placeOrderReceiptContainerContainer">
                ...
                <div class=" mX-5 alnsE alnsC-400 column alnE jstfyC">
                    ...
                    <div class="promocodeForm none">
                        <input showPlaceholder="orders.promoCode" class="promocodeCode" type="text" name="" id="promocodeCode">
                        <button class="promocodeApplyBtn" showText="orders.apply" id="promocodeApplyBtn"></button>
                    </div>
                    <div id="promocode-Loading" class="loadingPromocode none zx-5"><div></div><div></div><div></div></div>
                    <div class="w-200 taC fs-08 cE vH alnsS placeOrderFail" id="placeOrderFailPromocode" ></div>
                </div>
        ...
        <div id="trackOrder-Loading" class="loading none  zx-5"><div></div><div></div><div></div></div>
        ...
        <div id="deleteChatMsg-Loading" class="loading none zx-5"><div></div><div></div><div></div></div>
        <div  id="deleteChatMsg-popup" class="popupContent">
            ...
            <div class="mT-20 row alnC jstfyC">
                <button showText="liveChat.deleteMsg" class="mX-10 btn_error" id="deleteChatMsg-delete"></button>
