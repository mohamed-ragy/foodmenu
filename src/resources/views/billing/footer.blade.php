<div class="w100p row wrap alnS jstfyC mTa brdrTopS ">

    <div class="row wrap alnS jstfyS">
        <div class="mX40 mY30 fs09">
            <div class="">
        ...
        <div class="mX40 mY30 column alnS jstfyS">
            ...
            @endif
            <a class="fs09 mis-5" href="{{ env('HELP_CENTER_URL') }}/{{ $lang }}">{{ trans('help/help.footer.helpCenter') }}</a>
